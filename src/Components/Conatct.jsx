    ...
    return (
        <div className='row'>
            <div className='col-md-6 col-sm-12 col-12'>
                ...
                <div className='background text-light text-center p-3 mt-1'>
                  VPO BarwalaMuzaffarnagar,UP
                </div>
                <div className="mapouter mt-2 mb-2"><div class="gmap_canvas"><iframe width="100%" height="500"  id="gmap_canvas" src="https://maps.google.com/maps?q=vpo barwala%20s%2016%20muzaffarnagar&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div></div>
            </div>
            <div className='col-md-6 col-sm-12 col-12'>
